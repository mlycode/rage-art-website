    ...
    render () {
        ...
        return (
            <Fragment>
                ...
                <ArtworkCard img={img6} title="Crash The Party" year="2019" subtitle="Acrylic on Canvas, 76cm x 76cm"></ArtworkCard>
                <ArtworkCard img={img7} title="Perfect Love" year="2019" subtitle="Acrylic and Spray paint on Canvas"></ArtworkCard>
                <ArtworkCard img={img8} title="Oh God" year="2019" subtitle="Acrylic and Spray paint on Canvas, 40cm x 40cm"></ArtworkCard>
