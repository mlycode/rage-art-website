    ...
    render () {
        ...
        return (
            <Fragment>
                ...
                <ArtworkCard img={img1} title="Ya Butt" year="2018" subtitle="Digital Illustration"></ArtworkCard>
                <ArtworkCard img={img2} title="Ya Butt" year="2018" subtitle="Digital Illustration"></ArtworkCard>
                <ArtworkCard img={img3} title="Ya Butt" year="2018" subtitle="Digital Illustration"></ArtworkCard>
                <ArtworkCard img={img4} title="Ya Butt" year="2018" subtitle="Digital Illustration"></ArtworkCard>
                <ArtworkCard img={img5} title="Ya Butt" year="2018" subtitle="Digital Illustration"></ArtworkCard>
            </Fragment>
        );
    };
};
